...
简历结构（严禁包含联系方式部分）：
1. 自我评价 — 6~10句话，约200~300字，深入阐述资历背景、核心优势、行业洞察，并明确呼应职位描述中的关键要求
2. 专业技能 — 分类列出技术栈和工具，确保覆盖职位描述中提到的关键技术、框架和方法论；对职位描述重点要求的技术栈，应展开说明熟练程度和应用场景
3. 工作经历 — 4家以上公司，每家公司包含：
   - 公司名称（使用真实、可信的中大型互联网公司或科技企业名，避免使用过于知名的一线巨头如字节跳动、阿里巴巴、腾讯等）、任职时间、职位
   - 3~5条详细的工作描述，体现职责范围、业务影响、管理规模、团队角色以及取得的量化成果
4. 项目经历 — 5个以上项目，每个项目必须与职位描述高度相关，包含以下详细内容：
   - 项目名称（使用真实、可信的具体项目名）、项目时间
   - 项目背景：详细说明项目目标、业务场景、用户规模、技术挑战
   - 技术栈：列出项目中使用的核心技术、框架、中间件、工具，并说明选用理由
   - 解决方案：详细描述技术架构设计、核心方案选型、关键设计决策、实现细节
   - 核心贡献：以"主导/负责/参与"开头，4~6条具量化成果的描述（如性能提升百分比、QPS提升数值、成本降低幅度、用户增长数据等）
   - 难点与亮点：2~3条技术难点、创新性解决方案及个人价值体现
5. 教育背景 — 本科，中国排名50~200的大学（使用真实、可信的大学名），标注专业、相关课程或研究方向

规则：
- 生成完整、结构清晰的中文简历（纯文本，不使用markdown格式）
- 严禁包含联系方式部分（不出现电话、邮箱、地址等）
- 使用有力的动词，尽可能量化成果和收益
- 使用真实、可信的具体公司名、大学名和项目名，严禁出现【公司A】、【大学名称】、【项目A】等占位符；公司名应选择中大型、可信的科技企业，避免过于知名的一线巨头
- 项目经历是简历核心，每个项目必须包含详细的技术栈、解决方案、核心贡献和技术亮点
- 如果职位描述提到特定的技术、框架或方法论，必须确保在技能部分突出显示，并自然融入项目经历中
- 简历内容必须充实、详尽，总字数应充分覆盖职位描述中的关键要求，避免过于简略或泛泛而谈
- 优先扩展与职位描述高度相关的经历、技能和项目，确保简历看起来为该职位量身定制
- 工作经历和项目经历的时间线必须合理、一致：项目时间应落在对应任职公司的时间段内，项目周期与项目规模匹配，各公司时间段之间无明显重叠或矛盾，整体时间线覆盖约8年经验
...
- 不要包含联系方式部分
- 使用真实、可信的公司名、大学名和项目名，严禁使用占位符；公司名应选择中大型可信科技企业，避免使用过于知名的一线巨头
- 简历内容必须充实详尽，重点扩展与职位描述高度相关的技术、经历和项目
- 工作经历和项目经历的时间线必须合理一致：每个项目的时间应落在对应公司任职期间，整体时间线覆盖约8年且无矛盾
- 简历需对ATS系统友好，自然融入职位描述中的关键词，并针对职位要求量身定制"""
